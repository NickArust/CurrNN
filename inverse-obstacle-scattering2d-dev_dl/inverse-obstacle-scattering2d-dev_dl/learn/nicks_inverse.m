...
if strcmp(data_type, 'nn_stored')
    ...
    pred_path = './data/star10_kh10_n48_10000/valid_data.mat';
...
%     %nc=10, k=10
% Define the number of data points, M
    M = nc; % Example value, replace it with the actual value you are using
