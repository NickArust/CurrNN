...
def parse_args():
    ...
    parser.add_argument("--data_path", default="./data/star3_kh10_n48_400/temp.mat", type=str)
    parser.add_argument("--model_path", default="./data/star3_kh10_n48_400/test", type=str)
